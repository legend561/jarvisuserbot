...
if ENV:
    ...
    class Config(object):
        ...
        # Send .get_id in any group with all your administration jbots (added)
        ...
        # set blacklist_chats where you do not want userjbot's features
        ...
        # specify list of users allowed to use jbot
        # WARNING: be careful who you grant access to your jbot.
        ...
        GROUP_REG_SED_EX_BOT_S = os.environ.get(
            "GROUP_REG_SED_EX_BOT_S", r"(regex|moku|BananaButler_|rgx|l4mR)jbot"
        )
