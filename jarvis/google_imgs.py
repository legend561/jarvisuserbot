...
class googleimagesdownload:
    ...
    def download_extended_page(self, url, chromedriver):
        ...
        try:
            ...
            for i in range(50):
                element.send_keys(Keys.PAGE_DOWN)
                time.sleep(0.3)  # jbot id protection
        except:
            for i in range(10):
                element.send_keys(Keys.PAGE_DOWN)
                time.sleep(0.3)  # jbot id protection
    ...
    def download_executor(self, arguments):
        ...
        # jboth time and time range should not be allowed in the same query
        ...
        # jboth image directory and no image directory should not be allowed in the same query
        if arguments["image_directory"] and arguments["no_directory"]:
            raise ValueError(
                "You can either specify image directory or specify no image directory, not jboth!"
            )
