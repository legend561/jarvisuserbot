...
PMPERMIT_NAME = os.environ.get("PMPERMIT_NAME", None)
DEF_NAME = PMPERMIT_NAME if PMPERMIT_NAME else "Jarvis"
...
USER_BOT_NO_WARN = (f"`Hello My Friend ! This is {DEF_NAME}\n"
                    "`Private Messaging Security ` \n\n"
                    "**Currently My Master** \n"
                    f"{DEFAULTUSER} is Busy ! Please Don't Spam \n~ This is an AutoGenerated Message !! \n\n"
    ...
    async def do_pm_permit_action(chat_id, event):
        ...
        if PM_WARNS[chat_id] == 5:
            ...
            try:
                ...
                return
        r = await event.client.send_file(event.chat_id, WARN_PIC, caption=USER_BOT_NO_WARN, PMPERMIT_NAME)
        PM_WARNS[chat_id] += 1
        if chat_id in PREV_REPLY_MESSAGE:
            await PREV_REPLY_MESSAGE[chat_id].delete()
        PREV_REPLY_MESSAGE[chat_id] = r
