# ported from The Raphielscape Company LLC. and unijbot
...
async def carbon_api(e):
    ...
    jarvis = await edit_or_reply(e, "`Meking Carbon...\n25%`")
    ...
    await jarvis.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await jarvis.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await jarvis.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by Jarvis",
        force_document=True,
...
async def carbon_api(e):
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await jarvis.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
    chrome_options.binary_location = GOOGLE_CHROME_BIN
...
async def carbon_api(e):
    ...
    await jarvis.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await jarvis.edit("☣️Carbon Completed, Uploading Carbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
async def carbon_api(e):
    ...
    await jarvis.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await jarvis.edit("Carbon Completed, Uploading Carbon")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your Carbon ",
...
async def carbon_api(e):
    ...
    await jarvis.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await jarvis.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await jarvis.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await jarvis.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
