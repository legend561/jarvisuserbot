...
@jarvis.on(jarvis_cmd(pattern="purl ?(.*)"))
@jarvis.on(jarvis_cmd(pattern="purl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@jarvis.on(jarvis_cmd(pattern="sang ?(.*)"))
@jarvis.on(jarvis_cmd(pattern="sang ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@jarvis.on(jarvis_cmd(pattern="reader ?(.*)"))
@jarvis.on(jarvis_cmd(pattern="reader ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@jarvis.on(jarvis_cmd(pattern="ad ?(.*)"))
@jarvis.on(jarvis_cmd(pattern="ad ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
