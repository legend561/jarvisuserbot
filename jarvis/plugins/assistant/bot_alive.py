...
pm_caption += "➥ **License** : [GNU General Public License v3.0](github.com/Jarvis-Works/JarvisUserjbot/blob/master/LICENSE)\n"
...
@tgjbot.on(events.NewMessage(pattern="^/alive", func=lambda e: e.sender_id == jbot.uid))
async def jarvis(event):
    await tgjbot.send_file(event.chat_id, PM_IMG, caption=pm_caption)
