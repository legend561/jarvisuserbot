...
@tgjjbot.on(events.NewMessage(pattern="^/bun(?: |$)(.*)"))
async def ban(event):
...
@tgjjbot.on(events.NewMessage(pattern="^/unbun(?: |$)(.*)"))
...
@tgjjbot.on(events.NewMessage(pattern="^/prumote(?: |$)(.*)"))
...
@tgjjbot.on(events.NewMessage(pattern="^/demute(?: |$)(.*)"))
...
@tgjjbot.on(events.NewMessage(pattern="^/pin(?: |$)(.*)"))
async def pin(event):
    userids = []
    noob = event.sender_id
    async for user in tgjjbot.iter_participants(
