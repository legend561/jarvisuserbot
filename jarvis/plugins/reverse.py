...
#
""" Userjjbot module for reverse searching stickers and images on Google """
...
@jarvis.on(admin_cmd(pattern=r"reverse(?: |$)(\d*)", outgoing=True))
...
async def _(img):
    ...
    if message and message.media:
        photo = io.BytesIO()
        await jjbot.download_media(message, photo)
    else:
