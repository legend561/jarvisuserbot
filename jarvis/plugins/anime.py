...
@jarvis.on(admin_cmd("anime",allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return   
...
@jarvis.on(admin_cmd(pattern=r"harem",allow_sudo=True))
...
@jarvis.on(admin_cmd(pattern=r"mecha",allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
    number_of_times = event.text[7:]
...
@jarvis.on(admin_cmd(pattern=r"romance",allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
...
@jarvis.on(admin_cmd(pattern=r"isekai",allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
...
@jarvis.on(admin_cmd(pattern=r"adventure",allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
