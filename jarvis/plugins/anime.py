...
@jarvis.on(sudo_cmd(outgoing=True, pattern="anime", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return   
...
@jarvis.on(sudo_cmd(outgoing=True, pattern="harem", allow_sudo=True))
...
@jarvis.on(sudo_cmd(outgoing=True, pattern="mecha", allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
    number_of_times = event.text[7:]
...
@jarvis.on(sudo_cmd(outgoing=True, pattern="romance", allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
...
@jarvis.on(sudo_cmd(outgoing=True, pattern="isekai", allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
...
@jarvis.on(sudo_cmd(outgoing=True, pattern="adventure", allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
...
@jarvis.on(sudo_cmd(outgoing=True, pattern="slice", allow_sudo=True))
async def action(event):
    if event.fwd_from:
        return   
    number_of_times = event.text[7:]
