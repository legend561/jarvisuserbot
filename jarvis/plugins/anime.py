...
@jarvis.on(jarvis_cmd(pattern=r"harem"))
...
@jarvis.on(jarvis_cmd(pattern=r"mecha"))
async def action(event):
    if event.fwd_from:
        return
    number_of_times = event.text[7:]
...
@jarvis.on(jarvis_cmd(pattern=r"romance"))
async def action(event):
    if event.fwd_from:
        return
...
@jarvis.on(jarvis_cmd(pattern=r"isekai"))
async def action(event):
    if event.fwd_from:
        return
...
@jarvis.on(jarvis_cmd(pattern=r"adventure"))
async def action(event):
    if event.fwd_from:
        return
...
@jarvis.on(jarvis_cmd(pattern=r"slice"))
async def action(event):
    if event.fwd_from:
        return
    number_of_times = event.text[7:]
