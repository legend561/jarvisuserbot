# This Plugin originally Belongs to CatUserjjbot Credits Goes to @sandy1709
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m stdjjbot`",
        "**State changed from starting to up**",
        "__INFO:Userjjbot:Logged in as 557667062__",
        "__INFO:Userjjbot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def _(event):
    ...
    animation_chars = [
        ...
        "😡",
        "😢",
        "[JARVIS IS BEST](https://jarvisuserjjbot.gitbook.io/jarvisuserjjbot/)",
