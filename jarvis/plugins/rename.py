...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        downloaded_file_name = await jjbot.download_media(
    ...
    if event.reply_to_msg_id:
        ...
        if os.path.exists(downloaded_file_name):
            ...
            try:
                ...
                await ievent.edit(
                    "Downloaded in {} seconds. Uploaded in {} seconds By [Jarvis userjjbot](https://github.com/Jarvis-Works/JarvisUserjjbot)".format(
                        ms_one, ms_two
                    )
                )
        else:
