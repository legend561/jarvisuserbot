...
async def _(event):
    ...
    if Config.PLUGIN_CHANNEL is None:
        ...
        return
    try:
        e = await jbot.get_entity(Config.PLUGIN_CHANNEL)
    except Exception as e:
        await event.edit(str(e))
    else:
        re_message = await event.get_reply_message()
        # https://t.me/telethonofftopic/78166
        fwd_message = await jbot.forward_messages(e, re_message, silent=True)
        await jbot.forward_messages(event.chat_id, fwd_message)
